...
//выбор товарищества
   ...
   $('.number-image-0').toggleClass('scroll-image-active');
   $("div.scroll-image-card").click(function(){
    $(".show-image-card img").attr('src',$(this).children().attr('src'));
   $(".scroll-image-active").toggleClass('scroll-image-active');
    $(this).toggleClass('scroll-image-active');
    if($(this).hasClass('number-image-0') || $(this).hasClass('number-image-1') ||$(this).hasClass('number-image-2'))
      $('#scroll-image').scrollLeft(0);
  else
    $('#scroll-image').scrollLeft(500);
   });
