                        ...
                        <form action="#" method="post" enctype="multipart/form-data" id="myform">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group form-check">
                                ...
                                <?php endif;?>
                                <?php if($userItem[0]['role']=='admin'):?>
                                <label class="my-1 mr-2" for="choosestatus">Выберите статус объявление</label>
                                <select class="custom-select my-1 mr-sm-2" id="choosestatus" name="status">
                                           <option value="0"
                                            <?php if(isset($_POST['status']) && $_POST['status']=='0'):?> selected <?php
                                            elseif(isset($status) && $status=='0'):?> selected <?php endif;?>>Пометить на удаление</option>
                                           <option value="1"
                                            <?php if(isset($_POST['status']) && $_POST['status']=='1'):?> selected <?php
                                            elseif(isset($status) && $status=='1'):?> selected <?php endif;?>>Новый</option>
                                           <option value="2"
                                            <?php if(isset($_POST['status']) && $_POST['status']=='2'):?> selected <?php
                                            elseif(isset($status) && $status=='2'):?> selected <?php endif;?>>Опубликовать</option>
                                        </select>
                                <?php else:?>
